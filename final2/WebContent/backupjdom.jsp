...
public class jdom{
  ...
  // for문을 사용해 준 것은 모든 데이터를 출력해 보기 위해서이다.
					...
					if (nNode.getNodeType() == Node.ELEMENT_NODE) {
						...
						System.out.println("----------------------------------------");
						System.out.println("탄사람수      : " + getTagValue("FIVE_RIDE_NUM", eElement));
						System.out.println("내린사람수      : " + getTagValue("FIVE_ALIGHT_NUM", eElement));
						r =getTagValue("FIVE_RIDE_NUM", eElement);
						a =getTagValue("FIVE_ALIGHT_NUM", eElement);
						list.add(rec);
					}
				}
	              ...
	              String dbCommand =  " update people set ride='"+r+"', alight='"+a+"'";
	             ...
	             rs.beforeFirst();
	              ...
	              while (  rs.next() ) {
	                        ...
	                        System.out.println(  rs.getString("ride") );
